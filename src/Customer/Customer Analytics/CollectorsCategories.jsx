  ...
  useEffect(() => {
    ...
    (async function () {
      try {
        ...
        data[2][1] = res.data.TempCity;
        data[3][1] = res.data.ScreensCity;
        data[1][1] = res.data.LapmsCity;
        data[4][1] = res.data.LargeEqipCity;
        data[5][1] = res.data.SmallEquipCity;
        data[6][1] = res.data.SmallITCity;

        data[2][2] = res.data.TempTotal;
        data[3][2] = res.data.ScreensTotal;
        data[1][2] = res.data.LapmsTotal;
