...
import EWaste from "./customerAnalytics/wasteGeneratedAnly";
import "./customer.css";
...
function CustomerHome() {
  ...
  return (
    <div className="home">
      ...
      {
        location.loaded ? localStorage.setItem("customer location",JSON.stringify(location)) :"Location data not found" 
      }
    </div>
  );
}
